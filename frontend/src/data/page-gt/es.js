module.exports = {
  'pageGT.introdcuingNew': 'Presentamos el nuevo Monte GT',
  'pageGT.customise':
    'Personaliza tu afinación con la aplicación IOS / Android',
  'pageGT.addTo': 'Agregar a la bolsa por USD',
  'pageGT.upTo': 'Hasta + 25% HP1 + 25% NM1',
  'pageGT.fuelSaving': '+ 15% de ahorro de combustible1',
  'pageGT.obd': 'OBDII<br> plug&play',
  'pageGT.app': 'Aplicación IOS / Android',

  // performance
  'pageGT.performance': 'Rendimiento desatado',
  'pageGT.calculateYour': 'Calcula tu ganancia de potencia',
  'pageGT.stock': 'Valores',
  'pageGT.withMonte': 'con Monte GT',

  // appUi
  'pageGT.everythingYou': 'Todo lo que necesita del ajuste de chips',
  'pageGT.introducingMonte':
    'Presentamos Monte GT, con función de control por teléfono inteligente, que le permite aumentar la potencia de su motor o ahorrar combustible en menos de 5 minutos, monitorear su velocidad y realizar pruebas de aceleración.',

  // appUi items
  'pageGT.uploadThe': 'Sube la melodía específica del vehículo',
  'pageGT.accessOur':
    'Acceda a nuestra base de datos de más de 6000 vehículos para cargar la configuración de ajuste de automóviles con nuestra aplicación Monte GT.',

  'pageGT.watchSpeed': 'Mira la velocidad en tiempo real',
  'pageGT.turnYour':
    'Convierte tu teléfono en velocímetro para proyectar con precisión tu velocidad actual.',

  'pageGT.switchBetween': 'Cambiar entre modos',
  'pageGT.selectDifferent':
    'Seleccione diferentes modos de rendimiento ECO, SPORT o RACE) para ayudar a ahorrar combustible o aumentar la potencia de su motor.',

  'pageGT.measureCar': 'Medir la aceleración del coche',
  'pageGT.0-60': 'Mida la aceleración 0-60, 0-100 con facilidad y precisión.',

  'pageGT.trackYour': 'Controle sus gastos de combustible',
  'pageGT.keepTrack':
    'Lleve un registro de cuánto ahorra en gasolina en el modo Eco',

  // odds
  'pageGT.hereIsWhy': 'Monte tuning <br />He aquí por qué',
  'pageGT.oddsUpToText':
    'Monte tuning es una solución de ajuste inteligente única, diseñada no solo para aumentar la potencia de su automóvil, sino que también combina herramientas prácticas como la capacidad de diagnosticar la salud del automóvil a través del lector / borrador de código de error, realizar pruebas de aceleración, medir la potencia en tiempo real.',
  ...
  'pageGT.downloadApp': 'Descarga la App gratis',
  'pageGT.addToBag': 'Agregar a la bolsa para',
  'pageGT.needHelp': '¿Necesito ayuda?',
  'pageGT.contactUs': 'Contacta con nosotros',

  // techSpecs
  'pageGT.techSpecs': 'Especificaciones técnicas',

  'pageGT.perfomanceFigures': 'Cifras de rendimiento',
  'pageGT.perfomanceFiguresText':
    'Hasta + 25%* más HP1 <br> Hasta + 25%* más NM1 <br> Hasta + 18%* de ahorro de combustible',

  'pageGT.warrantyReturn': 'Garantía y devolución',
  'pageGT.warrantyReturnText':
    '30 días de devolución de dinero y garantía de por vida y defectos.',

  'pageGT.software': 'Software',
  'pageGT.softwareText':
    'Núcleo de firmware Monte 2.2 - Aplicación IOS / Android con base de datos de ajuste específica del vehículo',

  'pageGT.hardware': 'Hardware',
  'pageGT.hardwareText':
    'Conector obdii de 16 pines <br> Temperatura de funcionamiento -40C° + 85C° <br> Voltaje de funcionamiento 7,5V - 20V',

  'pageGT.dimension': 'Dimensión',
  'pageGT.dimensionText': 'Largo 78 mm <br> Ancho 55 mm <br> Alto 18 mm',

  'pageGT.inTheBox': '¿Qué hay en la caja?',
  'pageGT.inTheBoxText':
    'Monte GT <br> Guía de inicio rápido <br> Conector OBDII <br> Soporte magnético <br> Pegatinas de coche',

  // reviews
  'pageGT.reviewTextBen':
    'Un chip de rendimiento mejora la economía de combustible de su vehículo y proporciona más potencia. Además, puede tener un gran efecto en la eficiencia de su vehículo. Dado que existe una variedad de chips de rendimiento, puede ser un desafío elegir el adecuado para su automóvil o camión. Y, es cierto, probablemente sea un poco sorprendente que exista tal potenciador. Pero aquí estamos. En la guía de compra a continuación, enumeramos las características de un excelente chip de ajuste y respondemos las preguntas frecuentes, para que pueda elegir el más adecuado para sus necesidades. <br/> <br/> Así que sin más preámbulos, veamos algunos de los mejores chips de rendimiento del mercado en este momento.',
  'pageGT.reviewTextElly':
    'Nuestro algoritmo de ajuste contiene un conjunto de direcciones EPROM que afectan directamente la eficiencia y el rendimiento.',

  'pageGT.moreFeedback': 'Más comentarios',

  // performanceCharts
  'pageGT.performanceAndEfficiency': 'Rendimiento y eficiencia bajo demanda',
  'pageGT.selectDrivingModes':
    'Seleccione entre 3 modos de conducción. CARRERA, DEPORTE y ECO. Ajuste cada modo para obtener el máximo rendimiento o eficiencia de combustible de su automóvil.',
  'pageGT.mercedesRaceMode': 'Mercedes AMG C63 + 47HP y + 61NM con modo RACE',
  'pageGT.chartsNmTitle': 'TORQUE NM',
  'pageGT.chartsHpTitle': 'POTENCIA HP',
